<?php 
    ...
    class Client extends Database {
        ...
        public function addClient($data) {
            // Prepare Query
            $this->db->query('INSERT INTO clients (nom, prenom, image_profile, gender, nom_utilisateur, email, mot_de_passe, telephone, date_naissance, role) VALUES (:nom, :prenom, :image_profile, :gender, :nom_utilisateur, :email, :mot_de_passe, :telephone, :date_naissance, :role)');
       ...
       public function getOneClient($id) {
        ...
        public function updateClient($data, $id) {
            // Prepare Query
            $this->db->query('UPDATE clients SET nom = :nom, prenom = :prenom, image_profile = :image_profile, gender = :gender, nom_utilisateur = :nom_utilisateur, email = :email, mot_de_passe = :mot_de_passe, telephone = :telephone, date_naissance = :date_naissance, role = :role WHERE id = :id');

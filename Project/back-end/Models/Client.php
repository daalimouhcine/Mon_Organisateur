<?php 
    ...
    class Client extends Database {
        ...
        public function addClient($data) {
            // Prepare Query
            $this->db->query('INSERT INTO clients (nom, prenom, email, mot_de_passe, telephone, role) VALUES (:nom, :prenom, :email, :mot_de_passe, :telephone, :role)');
       ...
       public function getOneClient($id) {
        ...
        public function updateClient($data, $id) {
            // Prepare Query
            $this->db->query('UPDATE clients SET nom = :nom, prenom = :prenom, nom_utilisateur = :nom_utilisateur, email = :email, mot_de_passe = :mot_de_passe, telephone = :telephone, role = :role WHERE id = :id');

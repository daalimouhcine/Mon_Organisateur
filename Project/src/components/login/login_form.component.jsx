...
const LoginForm: React.FC = () => {
    ...
    return (
        ...
        <div id='bg_form_style' className="lg:w-1/2 w-full flex items-center justify-center text-center md:px-16 px-0 z-0">
            <div id='bg_form_img' className="absolute lg:hidden z-10 inset-0 bg-gray-500 bg-no-repeat bg-cover items-center">
